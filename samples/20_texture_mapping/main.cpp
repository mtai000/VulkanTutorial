...
private:
    ...
    void createTextureImageView(){
        mTextureImageView = createImageView(mTextureImage,VK_FORMAT_R8G8B8_SRGB);
    }
    ...
    void createGraphicsPipeline(){
        auto vertShaderCode = readFile("shaders/19vert.spv");
        auto fragShaderCode = readFile("shaders/19frag.spv");
